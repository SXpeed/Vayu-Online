...
/** Prices are display strings on this site ("₹ 3,200"), not numbers. */
const price = text(40);
...
export const product = z.object({
    ...
    price,
    compareAt: price.optional().or(z.literal('')),
    description: text(4000).optional(),
    img: text(400).optional(),
    sub: text(64).optional(),
    isNew: z.boolean().optional(),
    status: z.enum(['live', 'draft', 'scheduled', 'archived']).optional(),
    stock: z.number().int().min(0).max(1_000_000).optional(),
    publishAt: text(40).optional(),
    categories: z.array(slug).max(20).optional(),
